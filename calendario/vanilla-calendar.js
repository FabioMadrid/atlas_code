    ...
    function VanillaCalendar(options) {
        ...
        const createCalendar = function () {
            ...
            <div class="vanilla-calendar-header">
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="previous"><svg xmlns="http://www.w3.org/2000/svg" width="10.73" height="17.939" viewBox="0 0 10.73 17.939"><path d="M1629,434l-7.557,8.317L1613.886,434" transform="translate(443.317 -1612.473) rotate(90)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></button>
                <div class="vanilla-calendar-header__label" data-calendar-label="month"></div>
                <button type="button" class="vanilla-calendar-btn" data-calendar-toggle="next"><svg xmlns="http://www.w3.org/2000/svg" width="10.729" height="17.939" viewBox="0 0 10.729 17.939"><path d="M1629,434l-7.557,8.317L1613.886,434" transform="translate(-432.587 1630.413) rotate(-90)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg></button>
            </div>
