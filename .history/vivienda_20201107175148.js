...
var fake = document.getElementsByClassName("fake-accordion");
var i2;

for (i2 = 0; i2 < fake.length; i2++) 
{
  fake[i2].addEventListener("click", function() 
  {
    this.classList.toggle("active-fake-accordion");
  });
}